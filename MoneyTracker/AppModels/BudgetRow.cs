...
namespace MoneyTracker.AppModels
{
    public class BudgetRow 
    {
        ...
        public BudgetRow(string column1, string column2, string column3, string column4, decimal moneyCol1, decimal moneyCol2, Enums.TableRowType rowType)
        {
            Column1 = column1;
            Column2 = column2;
            Column3 = column3;
        ...
        public BudgetRow(string column1, string column2, string column3, string column4, decimal moneyCol1, decimal moneyCol2,
            Enums.TableRowType rowType, ForecastRow forecastRow)
        {
            Column1 = column1;
            Column2 = column2;
            Column3 = column3;
        ...
        public BudgetRow(string column1, string column2, string column3, string column4, decimal moneyCol1, decimal moneyCol2,
        decimal moneyCol3, Enums.TableRowType rowType)
        {
            Column1 = column1;
            Column2 = column2;
            Column3 = column3;
